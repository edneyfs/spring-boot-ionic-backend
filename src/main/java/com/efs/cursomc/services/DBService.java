...
public class DBService {
	...
	public void instantiateTestDatabese() throws ParseException{
		...
		//------------------------------------------------------
		Cliente cli1 = new Cliente(null, "Maria Silva", "projetos.estudo.ti@gmail.com", "190", TipoCliente.PESSOAFISICA);
